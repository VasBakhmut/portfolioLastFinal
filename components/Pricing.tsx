				...
				<ScrollReveal>
					<div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
						<p className='section-label' style={{ justifyContent: 'center' }}>
							<span>&#8212;</span> COST GUIDE <span>&#8212;</span>
						</p>
						<h2 className='section-heading'>
							STARTING <span className='gradient-text'>PRICES</span>
						</h2>
						<p
							style={{
						...
						>
							Typical starting prices for the most common website and automation
							projects.{' '}
							<a
								href='#contact'
								style={{
							...
							>
								...
								<div
									style={{
										...
										right: 0,
										height: 3,
										background: `linear-gradient(90deg, ${plan.color}66, ${plan.color})`,
								...
								{plan.priceNote ? (
									...
									<p style={{ fontSize: '0.7rem', marginBottom: '1.125rem' }} />
								)}
					...
					{[
						{
							...
							price: 'from $99',
							period: ' AUD',
							note: 'Small AI solutions starting from',
							color: '#8b5cf6',
						},
						{
							name: 'Basic Care',
