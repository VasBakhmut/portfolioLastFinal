							...
							>
								{canShowMore && (
									<button
										onClick={() =>
											setVisibleCount(c =>
												Math.min(c + PAGE_SIZE, projectsProp.length),
											)
										}
										className='btn-outline'
									>
								...
								{canShowLess && (
									<button
										onClick={() =>
											setVisibleCount(c => Math.max(c - PAGE_SIZE, PAGE_SIZE))
										}
										className='btn-outline'
										style={{ opacity: 0.7 }}
									>
			...
			>
				...
				<div
					style={{
						...
						flexWrap: 'wrap',
						gap: '0.3rem',
						marginBottom: p.placeholder ? 0 : '0.875rem',
					}}
				>
					{p.tech.map(t => (
						<span
